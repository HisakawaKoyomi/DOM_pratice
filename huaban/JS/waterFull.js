function waterFull(parent, child) {
    ...
    // 2. 子盒子的定位
    // 2.1 定义高度数组
    var heightArr = [], boxHeight = 0, minBoxHeight = 0, minBoxIndex = 0,xyMargin = 16;
    // 2.2 遍历子盒子
    ...
    var parentHeight = allBox[allBox.length - 1].offsetTop + allBox[allBox.length - 1].offsetHeight;//消除了padding的影响
